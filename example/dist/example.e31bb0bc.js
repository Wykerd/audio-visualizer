...
var AudioVisualizer = require('../index.js');

var canvas = document.querySelector('canvas');
canvas.width = window.screen.width;
var audiovisualizer = new AudioVisualizer(document.querySelector('audio'), canvas, {
  back: '#1c2541',
  line: '#f56476',
...
btn.onclick = function () {
  audiovisualizer.audioContext.resume().then(function () {
    audiovisualizer.play();
    audiovisualizer.draw();
  });
};

audiovisualizer.audioElement.addEventListener("play", function () {
  btn.onclick = function () {
    return audiovisualizer.pause();
  };

  btn.textContent = 'Pause';
});
audiovisualizer.audioElement.addEventListener("pause", function () {
  btn.onclick = function () {
    return audiovisualizer.play();
  };

  btn.textContent = 'Play';
});
},{"../index.js":"../index.js"}],"../../../../../usr/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
